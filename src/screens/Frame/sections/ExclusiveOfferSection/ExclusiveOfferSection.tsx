...
export const ExclusiveOfferSection = (): JSX.Element => {
  ...
  return (
    <section className="w-full max-w-[1380px] mx-auto py-16">
      <h2 className="text-center [font-family:'Roboto_Slab',Helvetica] font-semibold text-[#224f34] text-[50px] mb-16">
        Feedback Corner
      </h2>
          ...
          >
            <CardContent className="p-0 relative h-full">
              <div className="absolute w-[158px] h-[84px] top-1.5 left-4">
                <div className="absolute top-[55px] left-[3px] [font-family:'Roboto_Slab',Helvetica] font-semibold text-[#224f34] text-[22px]">
                  {testimonial.name}
                </div>
                <div className="[font-family:'Roboto_Slab',Helvetica] text-black text-[50px] absolute top-0 left-0 font-semibold">
                  &quot;
                </div>
              </div>
              <div className="absolute w-[401px] top-[119px] left-[18px] [font-family:'Poppins',Helvetica] font-medium text-black text-base">
                {testimonial.text}
              </div>
            </CardContent>
          </Card>
